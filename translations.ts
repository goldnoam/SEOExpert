...
export const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    appSubtitle: 'Enter one or more URLs to submit to over 1000 major search engine ping services for faster indexing.',
    ...
    serviceCount: 'Sending to 1000+ major services per URL',
    themeLight: 'Bright',
    themeDark: 'Dark',
    themeColorful: 'Colorful',
    copyLogs: 'Copy Logs',
    logsCopied: 'Logs copied!',
    ahrefsDescription: 'Free SEO tools to monitor your website\'s health, backlinks, and keyword rankings.',
    gaDescription: 'Track website traffic, user behavior, and conversion metrics.',
    pagespeedDescription: 'Analyze your site\'s performance and get actionable insights to improve speed.',
    customPingServices: 'Custom Ping Services',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',
    advancedOptions: 'Advanced Options',
  },
  he: {
    appSubtitle: 'הזן כתובת URL אחת או יותר לשליחה ליותר מ-1000 שירותי פינג של מנועי חיפוש לאינדוקס מהיר יותר.',
    ...
    copyUrls: 'העתק כתובות',
    urlCount: 'כתובות תקינות: {count}',
    statusPending: 'ממתין',
    ...
    serviceCount: 'שולח ל-1000+ שירותים לכל URL',
    themeLight: 'בהיר (Bright)',
    themeDark: 'כהה',
    themeColorful: 'צבעוני',
    copyLogs: 'העתק יומן',
    logsCopied: 'היומן הועתק!',
    ahrefsDescription: 'כלי SEO חינמיים למעקב אחר בריאות האתר, קישורים נכנסים ודירוג מילות מפתח.',
    gaDescription: 'עקוב אחר תנועת האתר, התנהגות משתמשים ומדדי המרה.',
    pagespeedDescription: 'נתח את ביצועי האתר שלך וקבל תובנות מעשיות לשיפור המהירות.',
    customPingServices: 'שירותי פינג מותאמים אישית',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',
    advancedOptions: 'אפשרויות מתקדמות',
  },
  es: {
    appSubtitle: 'Ingrese una o más URLs para enviarlas a más de 1000 servicios de ping de motores de búsqueda para una indexación más rápida.',
    ...
    copyUrls: 'Copiar URLs',
    urlCount: 'URLs válidas: {count}',
    ...
    serviceCount: 'Enviando a 1000+ servicios por URL',
    themeLight: 'Brillante',
    themeDark: 'Oscuro',
    themeColorful: 'Colorido',
    copyLogs: 'Copiar registros',
    logsCopied: '¡Copiado!',
    ahrefsDescription: 'Herramientas SEO gratuitas para monitorear la salud de su sitio web, vínculos de retroceso y clasificación de palabras clave.',
    gaDescription: 'Realice un seguimiento del tráfico del sitio web, el comportamiento del usuario y las métricas de conversión.',
    pagespeedDescription: 'Analice el rendimiento de su sitio y obtenga información útil para mejorar la velocidad.',
    customPingServices: 'Servicios de Ping Personalizados',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',
    advancedOptions: 'Opciones Avanzadas',
  },
  fr: {
    appSubtitle: 'Entrez une ou plusieurs URL à soumettre à plus de 1000 services de ping des moteurs de recherche pour une indexation plus rapide.',
    ...
    serviceCount: 'Envoi à 1000+ services par URL',
    themeLight: 'Lumineux',
    themeDark: 'Sombre',
    themeColorful: 'Coloré',
    copyLogs: 'Copier le journal',
    logsCopied: 'Journal copié!',
    ahrefsDescription: 'Outils SEO gratuits pour surveiller la santé de votre site Web, les backlinks et le classement des mots clés.',
    gaDescription: 'Suivez le trafic du site Web, le comportement des utilisateurs et les mesures de conversion.',
    pagespeedDescription: 'Analysez les performances de votre site et obtenez des informations exploitables pour améliorer la vitesse.',
    customPingServices: 'Services de Ping Personnalisés',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',
    advancedOptions: 'Options Avancées',
  },
  de: {
    appSubtitle: 'Geben Sie URLs ein, um sie zur schnelleren Indizierung an über 1000 Suchmaschinen-Ping-Dienste zu senden.',
    ...
    serviceCount: 'Sendet an 1000+ Dienste pro URL',
    themeLight: 'Hell (Bright)',
    themeDark: 'Dunkel',
    themeColorful: 'Farbenfroh',
    copyLogs: 'Protokoll kopieren',
    logsCopied: 'Kopiert!',
    ahrefsDescription: 'Kostenlose SEO-Tools zur Überwachung des Zustands Ihrer Website, von Backlinks und Keyword-Rankings.',
    gaDescription: 'Verfolgen Sie Website-Traffic, Nutzerverhalten und Conversion-Metriken.',
    pagespeedDescription: 'Analysieren Sie die Leistung Ihrer Website und erhalten Sie umsetzbare Erkenntnisse zur Verbesserung der Geschwindigkeit.',
    customPingServices: 'Benutzerdefinierte Ping-Dienste',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',
    advancedOptions: 'Erweiterte Optionen',
  },
  ja: {
    appSubtitle: 'インデックス登録を高速化するために、1000以上の主要な検索エンジンのpingサービスにURLを送信します。',
    ...
    serviceCount: 'URLあたり1000個以上のサービスに送信中',
    themeLight: 'ブライト',
    themeDark: 'ダーク',
    themeColorful: 'カラフル',
    copyLogs: 'ログをコピー',
    logsCopied: 'コピーしました！',
    ahrefsDescription: 'ウェブサイトの健全性、バックリンク、キーワードランキングを監視するための無料SEOツール。',
    gaDescription: 'ウェブサイトのトラフィック、ユーザーの行動、コンバージョン指標を追跡します。',
    pagespeedDescription: 'サイトのパフォーマンスを分析し、速度を向上させるための実用的な洞察を得ます。',
    customPingServices: 'カスタムPingサービス',
    customPingPlaceholder: 'https://custom-indexer.com/ping?url={URL}',

...
export const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    appSubtitle: 'Enter one or more URLs to submit to over 215 major search engine ping services for faster indexing.',
    ...
    serviceCount: 'Sending to 215+ major services per URL',
  },
  he: {
    appSubtitle: 'הזן כתובת URL אחת או יותר לשליחה ליותר מ-215 שירותי פינג של מנועי חיפוש לאינדוקס מהיר יותר.',
    ...
    serviceCount: 'שולח ל-215+ שירותים לכל URL',
  },
  es: {
    appSubtitle: 'Ingrese una o más URLs para enviarlas a más de 215 servicios de ping de motores de búsqueda para una indexación más rápida.',
    ...
    serviceCount: 'Enviando a 215+ servicios por URL',
  },
  fr: {
    appSubtitle: 'Entrez une ou plusieurs URL à soumettre à plus de 215 services de ping des moteurs de recherche pour une indexation plus rapide.',
    ...
    serviceCount: 'Envoi à 215+ services par URL',
  },
  de: {
    appSubtitle: 'Geben Sie URLs ein, um sie zur schnelleren Indizierung an über 215 Suchmaschinen-Ping-Dienste zu senden.',
    ...
    serviceCount: 'Sendet an 215+ Dienste pro URL',
  },
  ja: {
    appSubtitle: 'インデックス登録を高速化するために、215以上の主要な検索エンジンのpingサービスにURLを送信します。',
    ...
    serviceCount: 'URLあたり215個以上のサービスに送信中',
  },
};

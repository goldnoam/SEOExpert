...
export const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    appSubtitle: 'Enter one or more URLs to submit to over 250 major search engine ping services for faster indexing.',
    ...
    serviceCount: 'Sending to 250+ major services per URL',
    themeLight: 'Light',
    themeDark: 'Dark',
  ...
  he: {
    appSubtitle: 'הזן כתובת URL אחת או יותר לשליחה ליותר מ-250 שירותי פינג של מנועי חיפוש לאינדוקס מהיר יותר.',
    ...
    serviceCount: 'שולח ל-250+ שירותים לכל URL',
    themeLight: 'בהיר',
    themeDark: 'כהה',
  ...
  es: {
    appSubtitle: 'Ingrese una o más URLs para enviarlas a más de 250 servicios de ping de motores de búsqueda para una indexación más rápida.',
    ...
    serviceCount: 'Enviando a 250+ servicios por URL',
    themeLight: 'Claro',
    themeDark: 'Oscuro',
  ...
  fr: {
    appSubtitle: 'Entrez une ou plusieurs URL à soumettre à plus de 250 services de ping des moteurs de recherche pour une indexation plus rapide.',
    ...
    serviceCount: 'Envoi à 250+ services par URL',
    themeLight: 'Clair',
    themeDark: 'Sombre',
  ...
  de: {
    appSubtitle: 'Geben Sie URLs ein, um sie zur schnelleren Indizierung an über 250 Suchmaschinen-Ping-Dienste zu senden.',
    ...
    serviceCount: 'Sendet an 250+ Dienste pro URL',
    themeLight: 'Hell',
    themeDark: 'Dunkel',
  ...
  ja: {
    appSubtitle: 'インデックス登録を高速化するために、250以上の主要な検索エンジンのpingサービスにURLを送信します。',
    ...
    serviceCount: 'URLあたり250個以上のサービスに送信中',
    themeLight: 'ライト',
    themeDark: 'ダーク',
    themeColorful: 'カラフル',
    copyLogs: 'ログをコピー',

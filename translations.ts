...
export const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    appSubtitle: 'Enter one or more URLs to submit to over 500 major search engine ping services for faster indexing.',
    ...
    serviceCount: 'Sending to 500+ major services per URL',
    themeLight: 'Bright',
    themeDark: 'Dark',
  ...
  he: {
    appSubtitle: 'הזן כתובת URL אחת או יותר לשליחה ליותר מ-500 שירותי פינג של מנועי חיפוש לאינדוקס מהיר יותר.',
    ...
    serviceCount: 'שולח ל-500+ שירותים לכל URL',
  ...
  es: {
    appSubtitle: 'Ingrese una o más URLs para enviarlas a más de 500 servicios de ping de motores de búsqueda para una indexación más rápida.',
    ...
    serviceCount: 'Enviando a 500+ servicios por URL',
  ...
  fr: {
    appSubtitle: 'Entrez une ou plusieurs URL à soumettre à plus de 500 services de ping des moteurs de recherche pour une indexation plus rapide.',
    ...
    serviceCount: 'Envoi à 500+ services par URL',
    themeLight: 'Lumineux',
    themeDark: 'Sombre',
  ...
  de: {
    appSubtitle: 'Geben Sie URLs ein, um sie zur schnelleren Indizierung an über 500 Suchmaschinen-Ping-Dienste zu senden.',
    ...
    serviceCount: 'Sendet an 500+ Dienste pro URL',
  ...
  ja: {
    appSubtitle: 'インデックス登録を高速化するために、500以上の主要な検索エンジンのpingサービスにURLを送信します。',
    ...
    serviceCount: 'URLあたり500個以上のサービスに送信中',
    themeLight: 'ブライト',
    themeDark: 'ダーク',
    themeColorful: 'カラフル',
    copyLogs: 'ログをコピー',
